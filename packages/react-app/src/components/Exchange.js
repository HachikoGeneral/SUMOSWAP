...
import { getAvailableTokens, getCounterpartTokens, findPoolByTokens, 
  isOperationPending, getFailureMessage, getSuccessMessage } from '../utils'
...
const Exchange = ({ pools }) => {
  ...
  fromValueIsGreatThan0 && hasEnoughBalance;
